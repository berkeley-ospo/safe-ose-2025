...
For example, in high energy physics, the ATLAS and CMS LHC experiments rely on scientific Python libraries for all stages of data analysis, including for the upcoming High-Luminosity LHC upgrade \citep{Jung:2025oqh,Bockelman:2023gbj,Albin:2023szc,CERN-LHCC-2022-005,Shope:2025ukx}.
